          ...
          <div className="relative">
            ...
            <div className="relative bg-white backdrop-blur-sm border border-slate-200 rounded-2xl shadow-2xl shadow-red-500/5 p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-slate-600">Sign in to your IBrand account</p>
              </div>

              {showDemo && (
                <Alert className="mb-6 bg-red-50 border-red-200 text-red-800">
                  <AlertDescription>
                    <strong>Demo Credentials:</strong> This is a demo, so you can use any email and password to log in.
