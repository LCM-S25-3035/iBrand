...
output_file = "C:/Users/raman/Desktop/iBrand/iBrand/scrape/Al Jazeera Git/aljazeera_articles.json"
...
def fetch_articles():
    ...
    for feed_url in rss_feeds:
        ...
        for entry in feed.entries:
            ...
            existing_links.add(entry.link)  # Avoid duplicate in same run
